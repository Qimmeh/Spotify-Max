...
contextBridge.exposeInMainWorld('desktopWindow', {
  ...
  openSpotifyMusicLogin: () => ipcRenderer.invoke('phantom-spotify-open-login'),
  getPhantomSpotifyToken: () => ipcRenderer.invoke('phantom-spotify-get-token'),
  executePhantomSpotify: (js) => ipcRenderer.invoke('phantom-spotify-execute', js),
  playPhantomSpotifyTrack: (uri) => ipcRenderer.invoke('phantom-spotify-play-uri', uri),
  pausePhantomSpotify: () => ipcRenderer.invoke('phantom-spotify-pause'),
  resumePhantomSpotify: () => ipcRenderer.invoke('phantom-spotify-resume'),
  logoutPhantomSpotify: () => ipcRenderer.invoke('phantom-spotify-logout'),
